                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{ route('product#list')}}">
                                <i class=" fas fa-solid fa-pizza-slice"></i>Products</a>
                        </li>
                    </ul>
                </nav>
            </div>
                                        ...
                                        <div class="account-dropdown__body">
                                            <div class="account-dropdown__item">
                                                <a href="{{ route('admin#details') }}">
                                                    <i class="fa-solid fa-user fs-4"></i>Account</a>
                                            </div>
                                        </div>
                                        <div class="account-dropdown__body">
                                            <div class="account-dropdown__item">
                                                <a href="{{ route('admin#list') }}">
                                                    <i class="fa-solid fa-users-gear fs-4"></i>Admin List</a>
                                            </div>
                                        </div>
                                        <div class="account-dropdown__body">
                                            <div class="account-dropdown__item">
                                                <a href="{{ route('admin#changePasswordPage') }}">
                                                    <i class="fa-solid fa-key fs-4"></i>Change Password</a>
                                            </div>
                                        </div>
